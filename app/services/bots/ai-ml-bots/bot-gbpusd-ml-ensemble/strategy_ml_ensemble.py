"""
GBP/USD ML Ensemble Trading Strategy
...
from gbpusd_signal_engine import get_current_signal
from app.utils.simple_news_avoidance import simple_news_avoidance

logger = logging.getLogger(__name__)

class GBPUSDMLEnsembleStrategy:
    ...
    def calculate_stop_loss_pips(self, entry_price: float, stop_loss: float) -> float:
        """Calculate stop loss in pips for GBP/USD"""
        # GBP/USD: 1 pip = 0.0001 (same as EUR/USD)
    ...
    def place_trade(self, signal: Dict) -> bool:
        ...
        try:
            ...
            if not atr:
                ...
                atr = 0.0010  # Default ATR for GBP/USD
    ...
    def run_cycle(self):
        ...
        try:
            logger.info("-" * 60)
            logger.info("🔄 Running GBP/USD ML Ensemble Strategy Cycle")
